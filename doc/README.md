...
layout of your interface and even make it altogether unusable.

Fortunately, nowadays there exist reasonable solutions to this problem. In
the context of web applications, for example, new fonts can be easily
imported through JavaScript and CSS. MAM provides support for loading fonts
...
value to an array of font family names. For example:
...
with the `textFont` and `text` functions.
...
*   [Importing
    fonts](https://gist.github.com/lbv/5621644#file-mam-example-fonts-js).
